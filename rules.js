...
const BENEFITS = {
  ...
  aposentadoria_tempo: {
    ...
    evaluate(answers) {
      ...
      return { class: "sem_direito", rationale: `Faltam ${target - contrib} anos de contribuição. Vamos te orientar sobre o caminho.` };
    }
  },
  auxilio_doenca: {
    ...
    evaluate(answers) {
      ...
      return { class: "precisa_avaliacao", rationale: `Faltam ${12 - cm} meses de carência (salvo se for doença do trabalho ou acidente, que não exige carência).` };
    }
  },
  salario_maternidade: {
